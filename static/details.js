...
function updateInvoice() {
	...
	var cells, a, i;
	var extra = parseFloat(document.getElementById('extra').innerHTML);
	...
	for (var a = document.querySelectorAll('tbody.inventory tr'), i = 0; a[i]; ++i) {
		...
		// set row total
		cells[9].innerHTML = parseFloat(parseFloat(price)+parseFloat(cgst)+parseFloat(sgst)).toFixed(2);
	}
	...
	cells[0].innerHTML = total.toFixed(2);
